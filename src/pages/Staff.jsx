...
const Staff = () => {
  ...
  const mockStaff = [
    ...
    },
    {
      ...
      email: 'k.mtshali@stkcollege.com',
      phone: '+27123456789',
    ...
    },
    {
      ...
      experience: '24/7',
      qualifications: 'Matric Upgrade Support, Java & Web Tutoring',
      ...
      subjects: ['Matric Upgrade Support', 'Java & Web Tutoring', '24/7 Availability'],
      rating: 4.9,
