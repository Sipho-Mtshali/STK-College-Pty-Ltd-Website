...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About Us"
        description="Learn about STK College's mission, vision, and commitment to practical IT education, programming courses, and AI learnerships in South Africa."
        canonical="https://stkcollege.org/about"
        keywords="about STK College, IT training South Africa, programming courses, AI learnerships, tech education"
      />
      <StructuredData schema={organizationSchema} />
      <StructuredData
        schema={breadcrumbSchema([
          { name: 'Home', url: 'https://stkcollege.org/' },
          { name: 'About', url: 'https://stkcollege.org/about' },
        ])}
      />
