...
import { organizationSchema, breadcrumbSchema, courseSchema } from '../data/schema';
  ...
  return (
    <>
      <SEO
        ...
        canonical={`https://stkcollege.org/course/${id}`}
        keywords={`${course.title}, ${course.category}, IT training, STK College`}
      />
      ...
      <StructuredData
        schema={breadcrumbSchema([
          ...
          { name: course.title, url: `https://stkcollege.org/course/${id}` },
        ])}
      />
      <StructuredData schema={courseSchema(course)} />
